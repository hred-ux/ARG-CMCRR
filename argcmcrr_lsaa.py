...
model_class.load_state_dict(torch.load("/hy-tmp/github_script/ptFile/aa_long_class.pt",map_location=DEVICE))
model_mech.load_state_dict(torch.load("/hy-tmp/github_script/ptFile/mechanism_not_nonarg/aa_long_mechanism.pt",map_location=DEVICE))
...
def lsaa_predict(input_file, outfile):
