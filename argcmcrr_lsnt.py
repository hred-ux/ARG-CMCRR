import torch
from utils import process_lsnt
...
model_class.load_state_dict(torch.load("/hy-tmp/github_script/ptFile/nt_long_class.pt",map_location=DEVICE))
model_mech.load_state_dict(torch.load("/hy-tmp/github_script/ptFile/mechanism_not_nonarg/nt_long_mechanism.pt",map_location=DEVICE))
...
def lsnt_predict(input_file, outfile):
    print("Reading input file...")
    features, lengths, headers, seqs = process_lsnt(input_file)
