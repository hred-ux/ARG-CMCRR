...
model_class.load_state_dict(torch.load("/hy-tmp/github_script/ptFile/aa_short_class.pt",map_location=DEVICE))
model_mech.load_state_dict(torch.load("/hy-tmp/github_script/ptFile/mechanism_not_nonarg/aa_short_mechanism.pt",map_location=DEVICE))
